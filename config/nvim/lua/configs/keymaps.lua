...
-- floating terminal
map("n", "<leader>tg", "<CMD>lua _LAZYGIT_OPEN()<CR>", dopts("toggle lazygit terminal"))
...
map("n", "<leader>de", ":lua require'dap'.close()<CR>" .. ":lua require'dap'.terminate()<CR>" .. ":lua require'dap.repl'.close()<CR>" .. ":lua require'dapui'.close()<CR>" .. ":lua require('dap').clear_breakpoints()<CR>" .. "<C-w>o<CR>", opts)
...
-- goimpl
map("n", "<leader>im", "<Cmd>lua require'telescope'.extensions.goimpl.goimpl{}<CR>", dopts("go struct implement interface"))
