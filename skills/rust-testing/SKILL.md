---
name: rust-testing
description: Use when writing Rust unit tests, integration tests, or working with async testing, mocking, and test coverage.
---
...
- Writing or reviewing Rust tests
- Adding benchmarks or property-based tests
- User mentions: Rust testing, cargo test, doctests, proptest, mockall
